...
CREATE TABLE LeagueTeamB(
    lName VARCHAR(255),
    tNameB VARCHAR(255),
    cityB VARCHAR(255) NOT NULL,
    PRIMARY KEY (lName, tNameB),
    FOREIGN KEY (lName) REFERENCES LeagueOrganises (lName) ON DELETE CASCADE,
    FOREIGN KEY (tNameB, cityB) REFERENCES TeamHomeStadium (tName, city) ON DELETE CASCADE
);
...
VALUES ('NHL', 1, 111.11, 'Ice Hockey');
INSERT INTO LeagueOrganises(lName, tier, revenue, sportName)
VALUES ('Premier League', 1, 222.22, 'Soccer');
INSERT INTO LeagueOrganises(lName, tier, revenue, sportName)
VALUES ('U Sports', 2, 333.33, 'American Football');
INSERT INTO LeagueOrganises(lName, tier, revenue, sportName)
VALUES ('NBA', 1, 444.44, 'Basketball');
INSERT INTO LeagueOrganises(lName, tier, revenue, sportName)
VALUES ('MLB', 1, 555.55, 'Baseball');
